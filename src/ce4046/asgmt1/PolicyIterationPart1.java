...
public class PolicyIterationPart1 {
	...
	public static void main (String[] args) {
		...
		String fileName = "PolicyIterationPart1.csv";
		...
		maze[0][0].setReward(1);
		maze[0][1].setWall(true);
		maze[0][2].setReward(1);
		maze[0][5].setReward(1);
		
		maze[1][1].setReward(-1);
		maze[1][3].setReward(1);
		maze[1][4].setWall(true);
		maze[1][5].setReward(-1);
		
		maze[2][2].setReward(-1);
		maze[2][4].setReward(1);
		
		maze[3][3].setReward(-1);
		maze[3][5].setReward(1);
		
		maze[4][1].setWall(true);
		maze[4][2].setWall(true);
		maze[4][3].setWall(true);
		maze[4][4].setReward(-1);
